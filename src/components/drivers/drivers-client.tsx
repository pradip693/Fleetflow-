...
export function DriversClient({ initialDrivers }: DriversClientProps) {
    const { drivers: storeDrivers, addDriver, updateDriver, fetchDrivers } = useFleetStore();
            ...
            {paginatedDrivers.map((driver) => {
              ...
              return (
                <Card key={driver.id} className="relative overflow-hidden">
                  {expired && (
                    <div className="absolute top-0 left-0 right-0 bg-red-600 text-white text-xs font-bold text-center py-1 flex items-center justify-center gap-1 text-white">
